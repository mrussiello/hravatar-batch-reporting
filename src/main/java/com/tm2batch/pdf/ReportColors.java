...
public class ReportColors 
{
    ...
    public BaseColor hraBlue = new BaseColor( 0x21, 0x96, 0xf3 );// = new BaseColor( 0x27, 0xb2, 0xe7 );
    public BaseColor barGraphCoreShade1 = new BaseColor( 0x21, 0x96, 0xf3 );// new BaseColor( 0x27, 0xb2, 0xe7 ); // f68d2f // new BaseColor( 0xf6, 0x8d, 0x2f ); // f68d2f
    public BaseColor barGraphCoreShade2 =  new BaseColor( 0x51, 0xb1, 0xfa );// new BaseColor( 0xab, 0xe7, 0xff );
    
    
    public static ReportColors getCt2Colors( boolean dev )
    {
        ReportColors ctc = new ReportColors();
