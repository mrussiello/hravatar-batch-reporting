...
public class TestEventResponseRating implements Serializable, Comparable<TestEventResponseRating>
{
    ...
    */
    ...
    public String getMatchingRatingStrForCategoryName( String catName )
    {
        if( this.getRatingNameList()==null || !getRatingNameList().contains( catName ) )
            return null;
        
        int idx =getRatingNameList().indexOf(catName);
        if( idx==0 )
            return this.getRatingAsStr();
        if( idx==1 )
            return this.getRatingAsStr2();
        if( idx==2 )
            return this.getRatingAsStr3();
        if( idx==3 )
            return this.getRatingAsStr4();
        if( idx==4 )
            return this.getRatingAsStr5();
        if( idx==5 )
            return this.getRatingAsStr6();
        if( idx==6 )
            return this.getRatingAsStr7();
        if( idx==7 )
            return this.getRatingAsStr8();
        if( idx==8 )
            return this.getRatingAsStr9();
        if( idx==9 )
            return this.getRatingAsStr10();
    ...
    public void copyRatingsFrom( TestEventResponseRating terr )
    {
        this.rating = terr.getRating();
        this.rating2 = terr.getRating2();
        this.rating3 = terr.getRating3();
        this.note = terr.getNote();
    }
    
    public void clearPointers()
    {
        this.userId=0;
        this.testEventResponseRatingTypeId=-1;
        this.uploadedUserFileId=0;
        this.avItemResponseId=0;
    ...
    public String getRatingNameX( int idx )
    {
        return ratingNameList==null || ratingNameList.size()<idx ? null : ratingNameList.get(idx-1 );
    }

    public String getRatingName()
    {
        return getRatingNameX( 1 );
    }
    public String getRatingName2()
    {
        return getRatingNameX( 2 );
    }
    public String getRatingName3()
    {
        return getRatingNameX( 3 );
    }
    public String getRatingName4()
    {
        return getRatingNameX( 4 );
    }
    public String getRatingName5()
    {
        return getRatingNameX( 5 );
    }
    public String getRatingName6()
    {
        return getRatingNameX( 6 );
    }
    public String getRatingName7()
    {
        return getRatingNameX( 7 );
    }
    public String getRatingName8()
    {
        return getRatingNameX( 8 );
    }
    public String getRatingName9()
    {
        return getRatingNameX( 9 );
    }
    public String getRatingName10()
    {
        return getRatingNameX( 10 );
    }
