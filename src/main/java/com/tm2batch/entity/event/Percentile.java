...
public class Percentile implements Serializable
{
    ...
    public String toString() {
        return "Percentile{" + "percentileId=" + percentileId + ", testEventId=" + testEventId + ", testEventScoreId=" + testEventScoreId + ", score=" + score + ", rawScore=" + rawScore + ", score2=" + score2 + ", percentileScoreTypeId=" + percentileScoreTypeId + ", suborgId=" + suborgId + ", ipCountry=" + ipCountry + '}';
    }
