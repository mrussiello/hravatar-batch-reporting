...
import com.tm2batch.ref.RcCompetencyStatusType;
import com.tm2batch.ref.RcCompetencyType;
...
public class RcCompetency implements Serializable, Comparable<RcCompetency>
{
    @Transient
    ...
    //public List<String> getOnetElementIdList()
    //{
    //    return StringUtils.getStrList( onetElementIds );
    //}
    ...
    //public List<RcItem> getRcItemList() {
    //    return rcItemList;
    //}

    //public void setRcItemList(List<RcItem> rcItemList) {
