...
public class RcItem implements Serializable, Comparable<RcItem>
{
    @Transient
    ...
    private float commentThresholdLow=1;

    @Column(name="commentthresholdhigh")
    private float commentThresholdHigh=10;
    ...
    */
    ...
    {
        return RcItemFormatType.getValue( this.itemFormatTypeId );
    }
    ...
    public boolean getSupportsScoreThresholds()
    {
        if( !getRcItemFormatType().getHasCommentsOptional() || getIncludeComments()!=1 )
            return false;
        
        // all radios with comments
        if( getRcItemFormatType().getIsRadio() )
            return true;
        
        // all ratings where ratings are required.
    ...
    {
        if( questionSub!=null && !questionSub.isBlank() )
            return questionSub;
        return question;
    }
    ...
    public boolean getHideSkipB() {
        return hideSkip==1;
    }

    public void setHideSkipB(boolean b) {
        this.hideSkip = b ? 1 : 0;
    }
    ...
    public boolean getSkipforCandidateB() {
        return skipforCandidate==1;
    }

    public void setSkipforCandidateB(boolean b) {
        this.skipforCandidate = b ? 1 : 0;
    }
    ...
    public boolean getIntParam1B() {
        return intParam1==1;
    }

    public void setIntParam1B(boolean b) {
        this.intParam1 = b ? 1 : 0;
    }
