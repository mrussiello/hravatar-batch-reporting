...
import com.tm2batch.proctor.SuspiciousKeyCodeType;
...
@NamedQueries( {
    ...
    @NamedQuery( name = "SuspiciousActivity.findByTestKeyId", query = "SELECT o FROM SuspiciousActivity AS o WHERE o.suspiciousActivitySourceTypeId=0 AND o.testKeyId=:testKeyId" ),
    ...
    @NamedQuery( name = "SuspiciousActivity.findByTestEventIdAndUserId", query = "SELECT o FROM SuspiciousActivity AS o WHERE o.suspiciousActivitySourceTypeId=0 AND o.testEventId=:testEventId AND o.userId=:userId" ),
    @NamedQuery( name = "SuspiciousActivity.findByLvCallId", query = "SELECT o FROM SuspiciousActivity AS o WHERE o.suspiciousActivitySourceTypeId=1 AND o.lvCallId=:lvCallId" )
} )
public class SuspiciousActivity implements Serializable, Comparable<SuspiciousActivity>
{
    ...
    public int getFloatParam1AsIntPercent()
    {
        return Math.round(floatParam1*100);        
    }
    ...
    public float getFloatParam1Abs() {
        return Math.abs(floatParam1);
    }
