...
public class TestResultUtils
{
                                               ...
                                               boolean includeBatteryTestEvents ) throws Exception
    {
        ...
        try
        {
            ...
            for( TestEvent te : tel )
            {
                ...
                //if( te.getOverallPercentile()>= 0 )
                //    te.setOverallPercentileStr( NumberUtils.getPctSuffixStr( locale , te.getOverallPercentile(), 0 ) );

                //if( te.getAccountPercentile()>= 0 )
                //    te.setAccountPercentileStr( NumberUtils.getPctSuffixStr( locale , te.getAccountPercentile(), 0 ) );

                //if( te.getCountryPercentile()>= 0 )
                //    te.setCountryPercentileStr( NumberUtils.getPctSuffixStr( locale , te.getCountryPercentile(), 0 ) );
            }

            if( !includeBatteryTestEvents )
            {
                LogService.logIt( "TestResultUtils.processViewTestResults() Removing BatteryEvents.");
        ...
        {
            LogService.logIt( e, "TestResultUtils.getTestResultList() " );
        }
        return out;
    }
    ...
    public void loadTestEventObjects( TestEvent te, List<BatteryScore> batteryScoreList, Locale locale, boolean forDetail ) throws Exception
    {
        ...
        {
            LogService.logIt( e, "TestResultUtils.loadTestEventObjects() " + (te==null ? "null" : te.toString() ) );
    ...
    public static List<TextAndTitle> getTextBasedResponseList( String inStr, String title, boolean includeFileUploads, boolean fileUploadsOnly, boolean setOrderInInt1)
    {
        ...
        try
        {
            ...
            while( st.hasMoreTokens() )
            {
               ...
               // LogService.logIt( "TestResultUtils.getTextBasedResponseList() q=" + q + ", a=" + a + ", r=" + r + ", upld=" + upld + ", hasString1="  +hasString1  );
                ...
                if( a != null )
                {
                    ...
                    {
                        LogService.logIt( "TestResultUtils.getTextBasedResponseList() URLDecoding AAA error. NON-FATAL  error=" + e.toString() + ", decoding: a=" + a );
                    }
                }
                ...
                if( q != null )
                {
                    ...
                    {
                        LogService.logIt( "TestResultUtils.getTextBasedResponseList() URLDecoding BBB NON-FATAL error=" + e.toString() + ", decoding: q=" + q );
                    }
                }
                ...
                if( r != null && r.indexOf( "uuf:" )>=0 )
                {
                    ...
                    // LogService.logIt( "TestResultUtils.getTextBasedResponseList() parsed uufid=" + uufid + " from " + r );
                }
                ...
                if( string1!=null && !string1.isEmpty() )
                {
                    ...
                    {
                        LogService.logIt( "TestResultUtils.getTextBasedResponseList() URLDecoding DDD string1 error. NON-FATAL  error=" + e.toString() + ", decoding: string1=" + string1 );
                    } 
                }
                ...
                if( q != null && ((a != null && a.trim().length()>0) || uufid>0 ))
                {
                    ...
                    //.logIt( "TestResultUtils.getTextBasedResponseList() Craeated TTL " + ttl.getString1() + " hasStr1=" + ttl.getHasString1() );
        ...
        {
            LogService.logIt( e, "TestResultUtils.getTextBasedResponseList() " );
        }
