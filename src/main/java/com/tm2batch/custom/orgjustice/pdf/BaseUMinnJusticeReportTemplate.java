   ...
   public float addBoldRegPair( float startY, String boldTxt, String regTxt ) throws Exception
    ...
    protected void addDimensionScoresDetailTable(int uminnJusticeDimensionTypeId) throws Exception
    {
        try
        {
            ...
            BaseColor rowColor = tableRowLite;
            Font dataFont = getFontXSmall();
            Font dataFontWhite = getFontXSmallWhite();
            Font titleFont = getFontXSmallWhite();

            
            // 9 columns
            t = new PdfPTable( new float[]{30,14,14,14,14,14,14} );
            t.setHorizontalAlignment( Element.ALIGN_CENTER );
            t.setTotalWidth( outerWid );
            t.setLockedWidth( true );
            t.setSplitRows(true);
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.All" ), titleFont ));
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.Female" ), titleFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor( uminnMaroonLite );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.Male" ), titleFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor( uminnMaroonLite );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.Urim" ), titleFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor( uminnMaroonLite );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.NonUrim" ), titleFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor( uminnMaroonLite );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            rowColor = tableRowLite;
            UMinnColorType colorType;
            ...
            colorType = UMinnJusticeReportUtils.getScoreColorTypeForDimension(uminnJusticeDimensionTypeId, dataSet.getDimensionAveragesOther()[uminnJusticeDimensionTypeId-1]);
            c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, dataSet.getDimensionAveragesOther()[uminnJusticeDimensionTypeId-1], overallScorePrecisionDigits), colorType.getDarkFont() ? dataFont : dataFontWhite ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor( colorType.getColor() );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, OrgJusticeNorms.dimensionAveragesOther[uminnJusticeDimensionTypeId-1], overallScorePrecisionDigits), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor( rowColor );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            for( int i=0;i<16;i++ )
            {
                ...
                rowColor = i%2==0 ? tableRowLite : tableRow;
                ...
                c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, dataSet.getItemScoreAveragesOther()[i], overallScorePrecisionDigits), dataFont ));
                c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
                c.setBackgroundColor( rowColor );
                c.setHorizontalAlignment( Element.ALIGN_CENTER );
                c.setPadding( 3 );
            ...
            if( uminnJusticeDimensionTypeId==4 )
            {
                ...
                c = new PdfPCell( new Paragraph( lmsg( "sn.scoresnote" ), this.getFont() ));
                c.setBorder( Rectangle.NO_BORDER );
                c.setHorizontalAlignment( Element.ALIGN_LEFT );
                c.setColspan(1);
                c.setPadding( 4 );
    ...
    protected void addGroupScoresDetailTable( int uminnJusticeGroupTypeId ) throws Exception
    {
        try
        {
            ...
            colorType = UMinnJusticeReportUtils.getScoreColorTypeForGroup(uminnJusticeGroupTypeId, dataSet.getGroupAveragesOther()[uminnJusticeGroupTypeId-1]);
            c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, dataSet.getGroupAveragesOther()[uminnJusticeGroupTypeId-1], overallScorePrecisionDigits), colorType.getDarkFont() ? dataFont : dataFontWhite ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor( colorType.getColor() );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, OrgJusticeNorms.groupAveragesOther[uminnJusticeGroupTypeId-1], overallScorePrecisionDigits), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor( rowColor );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            for( int ii=0;ii<16;ii++ )
            {
                ...
                rowColor = ii%2==0 ?  tableRowLite : tableRow;
                ...
                c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, dataSet.getGroupItemScoreAveragesOther()[uminnJusticeGroupTypeId-1][ii], overallScorePrecisionDigits), dataFont ));
                c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
                c.setBackgroundColor( rowColor );
                c.setHorizontalAlignment( Element.ALIGN_CENTER );
                c.setPadding( 3 );
            ...
            //{
            ///    if( groupType.equals( UMinnJusticeGroupType.PROGRAM_LEADERS))
            //    {
            //        this.addNewPage();
            //        y = currentYLevel;
            //    }
                
            if( uminnJusticeGroupTypeId==7 )
            {
                addNewPage();
                y = currentYLevel;    
    ...
    protected void addOverallScoresDetailTable() throws Exception
    {
        try
        {
            ...
            Font dataFont = getFontXSmall();
            Font dataFontWhite = getFontXSmallWhite();
            Font headerFont = this.getFontXSmallWhite();
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.All" ), headerFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor(uminnMaroon);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.Female" ), headerFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor(uminnMaroon);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.Male" ), headerFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor(uminnMaroon);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.Urim" ), headerFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor(uminnMaroon);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.NonUrim" ), headerFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor(uminnMaroon);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            colorType = UMinnJusticeReportUtils.getScoreColorTypeForOverall(dataSet.getOverallAvgOther());
            c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, dataSet.getOverallAvgOther(), overallScorePrecisionDigits), colorType.getDarkFont() ? dataFont : dataFontWhite ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor(colorType.getColor());
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, OrgJusticeNorms.overallAvgOther, overallScorePrecisionDigits), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
    ...
    protected void addOverallScoresPage() throws Exception
    {
        try
        {
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.Group" ), headerFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor( this.uminnMaroon );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            c.setColspan(8);
            c.setPadding( 3 );
            ...
            c = new PdfPCell( new Paragraph( "", headerFont ));
            c.setBorder( Rectangle.RIGHT );
            c.setHorizontalAlignment( Element.ALIGN_LEFT );
            c.setPadding( 3 );
            setRunDirection( c );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.AllGroups" ), headerFont ));
            c.setBackgroundColor( this.uminnMaroon );
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            for( int i=0;i<7;i++ )
            {
                ...
                c = new PdfPCell( new Paragraph( gType.getName(), headerFont ));
                c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
                c.setBackgroundColor( this.uminnMaroon );
                c.setHorizontalAlignment( Element.ALIGN_CENTER );
                c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "g.OverallJusticeScore" ), dataFont ));
            c.setBackgroundColor( rowColor );
            c.setBorder( Rectangle.BOX );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setColspan(1);
            ...
            for( int d=0;d<4;d++ )
            {
                ...
                rowColor = d%2==0 ? tableRow : tableRowLite;
    ...
    protected void addOverallSummaryPage() throws Exception
    {
        try
        {
            ...
            //int uo = (int) dataSet.getOverallCountOther();
            ...
            Phrase p = new Phrase();
            p.add( new Chunk(lmsg( "sum.p0.dates.p1", params ) + " " , getFont() ) );
            p.add( new Chunk(lmsg( "sum.p0.dates.p2", params ) + " " , getFontBold() ) );
    ...
    protected void addGenderUrimTables() throws Exception
    {
        try
        {
            float y = currentYLevel; // addTitle( currentYLevel, lmsg( "g.PreparationNotes" ), null );
            ...
            Font headerFont = getFontXSmallWhite();
            Font dataFont = getFontXSmall();
            
            // FIRST - DIMENSIONS SCALES
            PdfPTable t = new PdfPTable( new float[]{30,14,14,14,14,14,14} );
            t.setHorizontalAlignment( Element.ALIGN_CENTER );
            t.setTotalWidth( outerWid );
            t.setLockedWidth( true );
            t.setSplitRows(true);
            ...
            c = new PdfPCell( new Paragraph( lmsg( "brk.p0.count" ), headerFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor( uminnMaroonLite );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "brk.p0.overall" ), headerFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
            c.setBackgroundColor( uminnMaroonLite );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            for( UMinnJusticeDimensionType dimType : UMinnJusticeDimensionType.values() )
            {
                ...
                c = new PdfPCell( new Paragraph( dimType.getName(), headerFont ));
                c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
                c.setBackgroundColor( uminnMaroonLite );
                c.setHorizontalAlignment( Element.ALIGN_CENTER );
                c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            BaseColor rowColor = tableRowLite;
            // Next Row 
            c = new PdfPCell( new Paragraph( lmsg( "brk.p0.female" ), dataFont ));
            c.setBorder( Rectangle.BOX  );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            c.setBackgroundColor(rowColor);
            ...
            c = new PdfPCell( new Phrase( Integer.toString( (int)dataSet.getOverallCountFemale() ), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            // Next Row 
            c = new PdfPCell( new Paragraph( lmsg( "brk.p0.male" ), dataFont ));
            c.setBorder( Rectangle.BOX  );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Phrase( Integer.toString( (int)dataSet.getOverallCountMale() ), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            // Next Row 
            c = new PdfPCell( new Paragraph( lmsg( "brk.p0.other" ), dataFont ));
            c.setBorder( Rectangle.BOX  );
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            c.setBackgroundColor(rowColor);
            ...
            c = new PdfPCell( new Phrase( Integer.toString( (int)dataSet.getOverallCountOther() ), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, dataSet.getOverallAvgOther(), overallScorePrecisionDigits), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            for( UMinnJusticeDimensionType dimType : UMinnJusticeDimensionType.values() )
            {
                ...
                c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, dataSet.getDimensionAveragesOther()[dimType.getIndex()], overallScorePrecisionDigits), dataFont ));
                c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
                c.setBackgroundColor(rowColor);
                c.setHorizontalAlignment( Element.ALIGN_CENTER );
                c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            // Next Row 
            c = new PdfPCell( new Paragraph( lmsg( "brk.p0.urim" ), dataFont ));
            c.setBorder( Rectangle.BOX  );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Phrase( Integer.toString( (int)dataSet.getOverallCountUrim() ), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            // Next Row 
            c = new PdfPCell( new Paragraph( lmsg( "brk.p0.nonurim" ), dataFont ));
            c.setBorder( Rectangle.BOX  );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Phrase( Integer.toString( (int)dataSet.getOverallCountNonUrim() ), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            // Next Row 
            c = new PdfPCell( new Paragraph( lmsg( "brk.p0.total" ), dataFont ));
            c.setBorder( Rectangle.BOX  );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setVerticalAlignment( Element.ALIGN_MIDDLE );
            ...
            c = new PdfPCell( new Phrase( Integer.toString( (int)dataSet.getOverallCount() ), dataFont ));
            c.setBorder( Rectangle.BOTTOM | Rectangle.RIGHT );
            c.setBackgroundColor(rowColor);
            c.setHorizontalAlignment( Element.ALIGN_CENTER );
            c.setPadding( 3 );
            ...
            // SECOND - GROUP SCALES
            t = new PdfPTable( new float[]{15,11,11,11,11,11,11,11,11} );
            t.setHorizontalAlignment( Element.ALIGN_CENTER );
            t.setTotalWidth( outerWid );
            t.setLockedWidth( true );
            t.setSplitRows(true);
            ...
            */
            ...
            for( UMinnJusticeGroupType dimType : UMinnJusticeGroupType.values() )
            {
                ...
                c = new PdfPCell( new Paragraph( I18nUtils.getFormattedNumber(Locale.US, dataSet.getGroupAveragesOther()[dimType.getIndex()], overallScorePrecisionDigits), dataFont ));
                c.setBorder( Rectangle.BOTTOM | Rectangle.TOP | Rectangle.RIGHT );
                c.setBackgroundColor( rowColor );
                c.setHorizontalAlignment( Element.ALIGN_CENTER );
                c.setVerticalAlignment( Element.ALIGN_MIDDLE );
        ...
        {
            LogService.logIt( e, "BaseUMinnJusticeReportTemplate.addGenderUrimTables()" );
            throw new STException( e );
        }        
    ...
    protected void addSupplementaryMaterialsSection() throws Exception
    {
        try
        {
            float y = currentYLevel; 
            ...
            c = new PdfPCell( new Paragraph( lmsg( "smats.title" ), this.getFontBold() ));
            c.setBorder( Rectangle.NO_BORDER );
            c.setHorizontalAlignment( Element.ALIGN_LEFT );
            c.setColspan(3);
            c.setPadding( 4 );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "smats.p1" ), this.getFont() ));
            c.setBorder( Rectangle.NO_BORDER );
            c.setHorizontalAlignment( Element.ALIGN_LEFT );
            c.setColspan(3);
            c.setPadding( 2 );
            ...
            c = new PdfPCell( new Paragraph( lmsg( "smats.p2" ), this.getFont() ));
            c.setBorder( Rectangle.NO_BORDER );
            c.setHorizontalAlignment( Element.ALIGN_LEFT );
            c.setColspan(3);
            c.setPadding( 2 );
        ...
        {
            LogService.logIt( e, "BaseUMinnJusticeReportTemplate.addSupplementaryMaterialsSection()" );
            throw new STException( e );
        }        
    ...
    protected void addIntroductionSection() throws Exception
    {
        try
        {
            ...
            c = new PdfPCell( new Phrase( lmsg( "fp.p2.p2" ), font ));
            c.setBorder( Rectangle.NO_BORDER );
            c.setHorizontalAlignment( Element.ALIGN_LEFT );
            c.setColspan(3);
            c.setPadding( 4 );
    ...
    protected void addTableOfContentsSection() throws Exception
    {
        try
        {
            ...
            float y = addTitle( pageHeight - headerHgt - 60 , lmsg("contents.title"), null );  
            ...
            for( String s : contentsItems )
            {
                cl.add( new Chunk( s, this.fontLarge ) );                
            }
