 ...
 * @author Mike
 */
public class UMinnJusticeHeaderFooter extends PdfPageEventHelper
{
    public float CT2_MARGIN = StandardReportSettings.CT2_MARGIN;
    ...
    UMinnJusticeReportSettings reportSettings;
    
    UMinnJusticeReportUtils uminnJusticeReportUtils;
    



    public UMinnJusticeHeaderFooter( Document d , Locale l, String t, ReportData rd, UMinnJusticeReportSettings rs ) throws Exception
    {
        reportData = rd;
        ...
        title =  lmsg( "g.headerreporttitle", new String[]{ reportData.getUserName() } );
    ...
    public void init( PdfWriter w ) throws Exception
    {
        if( HEADER_HEIGHT == 0 )
        {
            ...
            HEADER_HEIGHT = Math.max( reportSettings.getLogoWhiteTextSmall().getScaledHeight(), HEADER_TITLE_HEIGHT ) + 20;

            HEADER_IMAGE_Y = pageHeight - ((HEADER_HEIGHT - reportSettings.getLogoWhiteTextSmall().getScaledHeight())/2 ) - reportSettings.getLogoWhiteTextSmall().getScaledHeight() - 1;
    ...
    private PdfPTable getHeaderTable( boolean dark )
    {
        ...
        try
        {
            ...
            //LogoCell
            PdfPCell c = new PdfPCell( reportSettings.getLogoWhiteTextSmall() );
