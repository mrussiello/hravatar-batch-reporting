...
public class DiscHeaderFooter extends PdfPageEventHelper
{
    ...
    public float CT2_MARGIN = DiscGroupReportSettings.CT2_MARGIN;
    ...
    DiscGroupReportSettings reportSettings;
    ...
    public DiscHeaderFooter( Document d , Locale l, String t, ReportData rd, DiscGroupReportSettings rs, Image custLogo, String[] feedbackReportFooterImageUrls ) throws Exception
    {
        reportData = rd;
