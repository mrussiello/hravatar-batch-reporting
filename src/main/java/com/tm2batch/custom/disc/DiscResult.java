 ...
 * @author miker
 */
public class DiscResult implements Comparable<DiscResult> {
    ...
    public void calculate()
    {
        ...
        int[] topIndexes = DiscReportUtils.getTopTraitIndexes(scoreMap);
        dominantTypeIndex=topIndexes[0];
        secondaryTraitIndex=topIndexes[1];        
    }
    
    public int getTwoLevelIndex()
    {
        if( secondaryTraitIndex<0 )
           return dominantTypeIndex*4 + dominantTypeIndex;

        return dominantTypeIndex*4 + secondaryTraitIndex;
    }
    ...
    {
        return !(scoreMap==null || scoreMap.size()<4 || dominantTypeIndex<0);
        
    }
    
    public float getValueForStyleIndex( int styleIndex )
    {
        return getValueForStyleLetter( DiscReportUtils.DISC_COMPETENCY_STUBS[styleIndex] );
    }
    ...
    public boolean equals(Object obj) {
        ...
        final DiscResult other = (DiscResult) obj;
    ...
    @Override
    public int compareTo(DiscResult o) 
    {
    ...
    public int getSecondaryTraitIndex() {
        return secondaryTraitIndex;
    }
