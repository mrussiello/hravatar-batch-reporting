...
import com.tm2batch.custom.disc.pdf.*;
...
public class LeaderStyleHeaderFooter extends PdfPageEventHelper
{
    ...
    public float CT2_MARGIN = LeaderStyleGroupReportSettings.CT2_MARGIN;
    ...
    LeaderStyleGroupReportSettings reportSettings;
    ...
    public LeaderStyleHeaderFooter( Document d , Locale l, String t, ReportData rd, LeaderStyleGroupReportSettings rs, Image custLogo, String[] feedbackReportFooterImageUrls ) throws Exception
    {
        reportData = rd;
    ...
    public void onStartPage( PdfWriter w, Document d )
    {
        ...
        //LogService.logIt( "LeaderStyleHeaderFooter.onStartPage() pageNumber=" + pageNumber );
        ...
        try
        {
            ITextUtils.addDirectColorRect( w, BaseColor.WHITE, 0, 0, pageWidth, pageHeight, 0, 1, true );
        }

        catch( Exception e )
        {
            LogService.logIt( e, "LeaderStyleHeaderFooter.onStartPage() drawing background. " );
        }
    }
    ...
    public void onEndPage( PdfWriter w, Document d )
    {
        ...
        {
            LogService.logIt(e, "LeaderStyleHeaderFooter.onEndPage() ");
        }
    ...
    {
        // LogService.logIt( "LeaderStyleHeaderFooter.onCloseDocument() " );
    ...
    private void addHeaderDark( PdfWriter w, Document d )
    {
        ...
        // LogService.logIt( "LeaderStyleHeaderFooter.addHeaderDark() pageNumber=" + pageNumber + ", HEADER_HEIGHT=" + HEADER_HEIGHT + ", HEADER_TITLE_HEIGHT=" + HEADER_TITLE_HEIGHT + ", HEADER_TITLE_Y=" + HEADER_TITLE_Y + ", HEADER_IMAGE_Y=" + HEADER_IMAGE_Y );
    }

    private void addHeader( PdfWriter w, Document d )
    {
        createHeader( w, d, true );    /// was false, but all dark now
        // LogService.logIt( "LeaderStyleHeaderFooter.addHeader() DONE pageNumber=" + pageNumber );
    }
    ...
    private void createHeader( PdfWriter w, Document d, boolean dark )
    {
        ...
        {
            LogService.logIt( e, "LeaderStyleHeaderFooter.createHeader() dark=" + dark );
        }
    }
    ...
    private PdfPTable getHeaderTable( boolean dark )
    {
        ...
        {
            LogService.logIt( e, "LeaderStyleHeaderFooter.getHeaderTable() ");
        }
    ...
    private void addFooter( PdfWriter w, Document d )
    {
        try
        {
            ...
            // LogService.logIt( "LeaderStyleHeaderFooter.addFooter() pageNumber=" + pageNumber + ", t.getTotalHeight()=" + t.getTotalHeight() );

            t.writeSelectedRows(0, -1, PAD, FOOTER_HEIGHT + 2, w.getDirectContent() );

            // LogService.logIt( "LeaderStyleHeaderFooter.addFooter() DONE pageNumber=" + pageNumber );

        }

        catch( Exception e )
        {
            LogService.logIt( e, "LeaderStyleHeaderFooter.addFooter() " );
        }
    }
    ...
    private PdfPTable getFooterTable()
    {
        ...
        {
            LogService.logIt( e, "LeaderStyleHeaderFooter.getFooterTable() ");
        }
    ...
    private PdfPTable getHeaderTableRTL()
    {
        ...
        {
            LogService.logIt( e, "LeaderStyleHeaderFooter.getHeaderTableRTL() ");
        }
