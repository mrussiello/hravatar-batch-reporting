 ...
 * @author Mike
 */
public class LeaderStylePageNumberCellEvent implements PdfPCellEvent
{
    BaseColor bgColor;
    ...
    public LeaderStylePageNumberCellEvent( String pageStr, BaseColor bgColor, BaseColor fgColor, Font font )
    {
    ...
    public void cellLayout( PdfPCell ppc, Rectangle rctngl, PdfContentByte[] pcbs )
    {
        ...
        {
            LogService.logIt( e, "LeaderStylePageNumberCellEvent.cellLayout() " );
        }
