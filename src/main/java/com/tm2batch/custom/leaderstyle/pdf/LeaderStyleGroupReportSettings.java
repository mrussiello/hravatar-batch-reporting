 ...
 * @author Mike
 */
public abstract class LeaderStyleGroupReportSettings extends StandardReportSettings implements ReportSettings {
    ...
    public LeaderStyleColors ct2Colors = null;
    ...
    public void initColors()
    {
        // Nothing. 
        if( ct2Colors == null )
            ct2Colors = LeaderStyleColors.getCt2Colors( devel );  
