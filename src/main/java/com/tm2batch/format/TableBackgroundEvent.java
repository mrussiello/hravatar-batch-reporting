 ...
 * @author Mike
 */
public class TableBackgroundEvent implements PdfPTableEvent, PdfPCellEvent
{
    ...
    public TableBackgroundEvent( BaseColor brdCol, float brdWid, BaseColor bgCol, float r )
    {
        borderColor = brdCol;
        borderWidth = brdWid;
        bgColor = bgCol;
    ...
    public TableBackgroundEvent( BaseColor brdCol, float brdWid, BaseColor bgCol )
    {
        borderColor = brdCol;
        borderWidth = brdWid;
        bgColor = bgCol;
                            ...
                            PdfContentByte[] canvas)
    {
            ...
            if( bgColor != null )
            {
                ...
                // LogService.logIt( "TableBackgroundEvent.tableLayout() height[0]=" + height[0] + ", height[height.length - 1]=" + height[height.length - 1] );
