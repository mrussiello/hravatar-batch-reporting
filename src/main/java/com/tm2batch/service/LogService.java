...
public class LogService
{
    ...
    public static void init() throws NamingException, Exception
    {
        if( logger == null )
        {
            ...
            if( filePattern == null )
                filePattern = "c:/work/tm2batch2/log/tm2batch_%g_%u.log";


            try
            {
                logger = Logger.getLogger( "com.tm2batch" );
    ...
    public static void logIt( Exception e, String message )
    {
        try
        {
            ...
            {
                logIt( message + ", " + ( e.getMessage() != null ? e.getMessage() : "" ) + "{" + ( (STException) e ).getKey() + "}" );
    ...
    public static void logIt( Throwable e, String message )
    {
        try
        {
            ...
            if( e instanceof STException )
            {
                logIt( message + ", " + e.getMessage() + "{" + ( (STException) e ).getKey() + "}" );
